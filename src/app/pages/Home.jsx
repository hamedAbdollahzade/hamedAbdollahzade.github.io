            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
              ...
              <span className="text-blue-600 dark:text-blue-400 font-medium">
                ...
                <motion.div variants={itemVariants} className="relative">
                    ...
                    >
                        <div
                            className="w-full aspect-square max-w-md mx-auto bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl p-1">
                    ...
                    <motion.div
                        ...
                        className="absolute -top-10 -right-10 w-24 h-24 rounded-2xl bg-blue-500/20 dark:bg-blue-500/10 backdrop-blur-sm"
                    />
                    <motion.div
                        animate={{y: [0, -14, 0], rotate: [0, -6, 0]}}
                        transition={{duration: 5, repeat: Infinity, ease: 'easeInOut'}}
                        className="absolute -bottom-10 -left-10 w-32 h-32 rounded-2xl bg-purple-500/20 dark:bg-purple-500/10 backdrop-blur-sm"
                    />
                </motion.div>
            </div>
