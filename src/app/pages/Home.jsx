...
export default function Home() {
    ...
    return (
        <main className="portfolio-shell min-h-screen overflow-hidden bg-slate-950 text-white">
            ...
            <section id="home" className="relative min-h-screen px-4  pt-12 sm:px-6 lg:px-8">
                ...
                >
                    <motion.div variants={fadeUp} className={isRTL ? 'text-center lg:text-right' : 'text-center lg:text-left'}>
                        <div className="mb-6 inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/8 px-4 py-2 text-sm text-cyan-100 shadow-2xl shadow-cyan-500/10 backdrop-blur-xl">
                            <span className="h-2.5 w-2.5 animate-pulse rounded-full bg-emerald-400" />
                            Available for modern frontend products
                        </div>

                        <Title className="!mb-5 !text-5xl !font-black !leading-[0.95] tracking-[-0.06em] !text-white sm:!text-6xl lg:!text-8xl">
                            {t('hero.name')}
                        ...
                        <Paragraph className="mx-auto !mb-8 max-w-2xl text-lg leading-8 !text-slate-300 lg:mx-0">
                            {t('hero.description')} I design fast, polished interfaces with React, enterprise dashboards,
            ...
            <section className="px-4 py-10 sm:px-6 lg:px-8">
                ...
                >
                    {[
                        ...
                        ['Dashboards', 'Complex forms and data flows'],
                        ['Motion', 'Scroll-aware storytelling'],
                    ].map(([title, text]) => (
                    ...
                    <RevealCard>
                        <Card className="glass-card h-full">
                            ...
                            <Paragraph className="!text-slate-300">
                                Frontend developer focused on React, Next.js, enterprise UI, API integration, and building maintainable interfaces for real products.
                            </Paragraph>
                ...
                <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-3">
                    {featuredProjects.map((project, index) => (
                        <RevealCard key={project.id} delay={index * 0.05}>
                            <Card className="project-card h-full" cover={
                                ...
                                <div className="flex gap-3">
                                    {project.githubLink && <Button href={project.githubLink} target="_blank" icon={<GithubOutlined />}>Code</Button>}
                                    <Button type="primary" href={project.liveLink} target="_blank" icon={<ArrowRightOutlined />}>Visit</Button>
                                </div>
                            </Card>
                        </RevealCard>
                    ))}
            ...
            <section id="experience" className="scroll-section px-4 py-24 sm:px-6 lg:px-8">
                ...
                <div className="mx-auto max-w-5xl space-y-5">
                    {workItems.map((item, index) => (
                        <RevealCard key={item.id} delay={index * 0.06}>
            ...
            <section className="scroll-section px-4 py-24 sm:px-6 lg:px-8">
                ...
                >
                    {sections.map((section) => (
                        <motion.div key={section.title} variants={fadeUp} className="roadmap-card">
                            <h3>{section.title}</h3>
                            <ul>
            ...
            <section id="contact" className="scroll-section px-4 py-24 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="mt-8 flex flex-wrap justify-center gap-4">
                        <Button type="primary" size="large" href="mailto:hamedabdollahzade.ab@gmail.com" icon={<MailOutlined />}>Email Me</Button>
                        <Button size="large" href="tel:+989107902735" icon={<PhoneOutlined />}>Call</Button>
                        <Button size="large" href="https://github.com/hamedAbdollahzade" target="_blank" icon={<GithubOutlined />}>GitHub</Button>
                        <Button size="large" href="https://www.linkedin.com/in/hamed-abdollahzade/" target="_blank" icon={<LinkedinOutlined />}>LinkedIn</Button>
                    </div>
                </motion.div>
            </section>
        </main>
